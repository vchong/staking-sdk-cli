...
def claim_pending_rewards(config):
    # read config
    ...
    try:
        tx_hash = send_transaction(w3, funded_private_key, contract_address, calldata_claim, chain_id, 0)
...
def claim_pending_rewards_cli(config: dict, val_id: int):
